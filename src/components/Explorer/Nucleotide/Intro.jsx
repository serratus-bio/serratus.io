...
const examples = (
    <>
        ...
        ,{' '}
        <a className="text-blue-600" href="?family=Circoviridae">
            Circoviridae
        </a>
        ,{' '}
        ...
        ,{' '}
        <a className="text-blue-600" href="?sequence=NC_001498.1">
            Ateline alphaherpesvirus 1 (NC_034446.1)
        </a>
        ,{' '}
        <a className="text-blue-600" href="?sequence=NC_034446.1">
