    ...
    <div className="flex font-montserrat font-medium">
      ...
      <div className="hidden sm:flex flex-row w-screen bg-gray-100 sm:p-4 justify-between z-10 border-b-2  border-gray-300">
        ...
        <div className="justify-flex-end mt-1 mr-10">
          ...
          <ExternalLink href="https://www.biorxiv.org/content/10.1101/2020.08.07.241729v2" className="ml-6 bg-white font-mono font-normal border-2 border-gray-600 rounded-lg p-2 hover:text-blue-600 hover:border-blue-600">Preprint</ExternalLink>
