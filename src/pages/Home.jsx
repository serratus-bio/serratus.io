        ...
        <div>
            ...
            <div className="h-screen w-screen fixed flex flex-col items-center justify-center">
                <div className="flex flex-col z-10 items-center text-white px-4">
                    ...
                    <h2 className="text-xl font-thin text-center z-10">An open-science viral discovery platform</h2>
                    <NavLink to="/query" className="border z-10 border-white flex text-xl mt-16 justify-center items-center w-auto  px-4 py-2 rounded-md hover:text-blue-600 hover:bg-white">
