        ...
        <div className="flex flex-col sm:flex-row absolute pb-12">
          <div className="sm:max-w-sm rounded-lg overflow-hidden bg-white shadow-2xl mt-40 sm:m-10 sm:pt-0">
            <div className="w-full flex flex-col justify-center items-center p-10">
              <img className="h-24 w-24" src="/db.png" alt="database" />
            </div>
            <div className="px-6 py-4">
              <div className="font-bold text-xl mb-2 text-center">NCBI SRA Database</div>
          ...
          <div className=" sm:max-w-sm rounded-lg overflow-hidden bg-white shadow-2xl mt-10 sm:m-10">
            <div className="w-full flex flex-col justify-center items-center p-6">
              <img className="w-32 h-32" src="cloud.png" alt="cloud" />
            </div>
            <div className="px-6 py-4">
              <div className="font-bold text-xl mb-2 text-center">Cloud Architecture</div>
              <p className="text-gray-700 text-base">
          ...
          <div className="sm:max-w-sm rounded-lg overflow-hidden bg-white shadow-2xl mt-40 sm:m-10 sm:pt-0">
            <div className="w-full flex flex-col justify-center items-center p-10">
              <img className="h-24 w-24" src="/dbcloud.png" alt="cloud db icon" />
            </div>
            <div className="px-6 py-4">
              <div className="font-bold text-xl mb-2 text-center">CoV Sequence Database</div>
              <p className="text-gray-700 text-base">
