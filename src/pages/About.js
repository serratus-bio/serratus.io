...
const About = () => {
    return (
        <div className="flex md:absolute w-screen flex-col h-screen justify-center items-center">
            ...
            <p className="font-sans sm:text-gray-700 text-s sm:text-xl mt-4">Currently, I am working on several different native applications as passion projects and am also contributing to an open source project that researches the Coronavirus.</p>
