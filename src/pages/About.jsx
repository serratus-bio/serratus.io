    ...
    <div className="min-h-screen w-full sm:bg-gray-200 py-4">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <AboutCard
          ...
          Planetary-scale data requires cloud-scale computing. The engine driving <b>Serratus</b> is a new type of cloud-computing architecture that we designed to process petabytes of sequencing data. Using Amazon Web Services we access up to 22,250 CPU allowing us to process data hundreds of times faster then was possible before.
        </AboutCard>
        <hr className="block sm:hidden" />
        <AboutCard
          ...
          We adhere to the Bermuda Principles set out originally by the Human Genome Project, all data is freely and publicly available within 24 hours of generation. Our goal is to advance science, if you require assistance accessing any data please <ExternalLink className="text-blue-600" href="https://github.com/ababaian/serratus/issues">open an issue on our GitHub</ExternalLink> and we can help.
        </AboutCard>
      </div>
    </div>
  )
...
const AboutCard = ({imgTop, imgTopAlt, title, text, imgBottom, imgBottomLink, imgBottomAlt, children}) => {
  return (
