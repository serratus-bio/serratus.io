...
const Home = () => {
    return (
        ...
        <div class="flex flex-col z-10 items-center text-white ">
            ...
            <a onClick="window.open(this.href); return false" href="https://github.com/ababaian/serratus/blob/master/CONTRIBUTING.md" class="border border-white flex text-xl mt-16 justify-center items-center w-auto  px-6 py-2 rounded-md hover:text-blue-600 hover:bg-white"> 
